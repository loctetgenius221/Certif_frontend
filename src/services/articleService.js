...
export const storeArticle = async (formData) => {
  try {
    const token = localStorage.getItem("token");
    ...
    console.log("Article crée :", response.data);
    return response.data;
  } catch (error) {
    console.log("hhgghh");
  }
...
//       }
//     });
//     console.log("Article enregistré dans brouillon :", response.data)
//     return response.data;
//   } catch (error) {
...
// export const scheduleArticle = async (article) => {
//   try {
//     const token = localStorage.getItem("token")
//     const response = await api.post("/articles", article, {
//       headers: {
...
//       }
//     });
//     console.log("Article programmé :", response.data)
//     return response.data;
//   } catch (error) {
//     console.error('Erreur lors de la programmation de l\'article :', error);
//     throw error;
//   }
// };
...
export const getAllComments = async () => {
  try {
    ...
    console.log("Liste des commentaires :", response.data);
    return response.data;
  } catch (error) {
...
export const deleteComments = async (commentId) => {
  try {
    ...
    console.log("Commentaire supprimer :", response.data);
    return response.data;
  } catch (error) {
    console.error("Erreur lors de la suppression du commentaires:", error);
...
export const getAllMedia = async () => {
  try {
    ...
    console.log("liste des média:", response.data);
    return response.data;
  } catch (error) {
    console.error("Erreur lors de la suppression du commentaires:", error);
...
export const updateMedia = async (id, formData) => {
  try {
    const token = localStorage.getItem("token");
    const response = await api.post(`/medias/${id}/edit`, formData, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
