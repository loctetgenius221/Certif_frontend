...
const submitForm = async () => {
  try {
    ...
    if (modalType.value === "antecedent") {
      ...
      try {
        antecedents =
          typeof oldData.data.antecedents_medicaux === "string"
      ...
      data = {
        antecedents_medicaux: JSON.stringify([
          ...antecedents,
          newAntecedent.value,
        ]),
      };
      ...
      try {
        traitements =
          typeof oldData.data.traitements === "string"
      ...
      try {
        notes =
          typeof oldData.data.notes_observations === "string"
      ...
      try {
        interventions =
          typeof oldData.data.intervention_chirurgicale === "string"
      ...
      data = {
        intervention_chirurgicale: JSON.stringify([
          ...interventions,
          newInterventation.value,
        ]),
      };
      ...
      try {
        infos =
          typeof oldData.data.info_sup === "string"
            ? JSON.parse(oldData.data.info_sup)
            : oldData.data.info_sup || [];
      } catch (e) {
        infos = oldData.data.info_sup ? [oldData.data.info_sup] : [];
      }
      data = {
